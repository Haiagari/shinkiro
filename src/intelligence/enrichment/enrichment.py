...
from src.core.target_normalizer import extract_target_host
...
def query_shodan(ip: str, api_key: str | None = None) -> dict[str, Any]:
    """
...
def query_censys(
    ip: str, api_id: str | None = None, api_secret: str | None = None
) -> dict[str, Any]:
    """
        ...
        if r.status_code == 200:
            ...
            if results:
                return {
                    ...
                    "certificates": [
                        c.get("parsed.subject_dn", "") for c in results[0].get(" certificates", [])
                    ],
                }
...
def query_crtsh(cert_domain: str) -> dict[str, Any]:
    """
...
def enrich_hosts(hosts: list, config: dict | None = None) -> dict[str, Any]:
    """
...
def run_enrichment(target: str, out_dir: Path, context: dict[str, Any]) -> dict[str, Any]:
    """
